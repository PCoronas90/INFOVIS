...
import org.infovis.finalproject.utils.ParsingKeywords;
...
public class IndexerKeyword {

	private IndexerKeyword() {
	}

	public static void main(String[] args) {

		String indexPath = "indexKeyword";
		...
		if (file.canRead()) {
			if (file.isDirectory()) {
				...
				try {
					...
					Map<String, ArrayList<String>> infoWithField = ParsingKeywords.parseKey(file);

					// make a new, empty document
					
                    
					Set<String> keyword= infoWithField.keySet();
					for(String key : keyword){
					Document doc = new Document();
					
					Field keyw= new TextField("keyword", key, Field.Store.YES);
