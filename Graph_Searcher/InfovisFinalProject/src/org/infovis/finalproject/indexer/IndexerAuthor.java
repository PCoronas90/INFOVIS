...
import org.infovis.finalproject.utils.ParsingAuthor;
...
public class IndexerAuthor {

	private IndexerAuthor() {
	}

	public static void main(String[] args) {

		String indexPath = "indexAuthor";
		...
		if (file.canRead()) {
			if (file.isDirectory()) {
				...
				try {
					...
					Map<String, ArrayList<String>> infoWithField = ParsingAuthor.parse(file);

					// make a new, empty document
					
                    
					Set<String> autori= infoWithField.keySet();
					for(String autore : autori){
					Document doc = new Document();
					
					Field author= new TextField("author", autore, Field.Store.YES);
